...
\name{Lu Yi} \\
{\large Temporal GNNs, Graph Unlearning, Graph Algorithms} \\
...
\role{ {\textbf{Lu Yi}}, Zhewei Wei. ICLR 2025. [\href{https://openreview.net/pdf?id=pPyJyeLriR}{\textcolor{blue}{\underline{PDF}}}]}
